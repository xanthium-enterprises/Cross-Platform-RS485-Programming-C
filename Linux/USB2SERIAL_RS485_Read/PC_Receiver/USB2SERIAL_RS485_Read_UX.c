    /*====================================================================================================*/
    /* USB to RS485 conversion  using USB2SERIAL (Read) (Receiver Side) (Linux API)                       */
	...
	/* Library       :                                                                                    */
	/* Commands      : gcc -o USB2SERIAL_RS485_Read_UX USB2SERIAL_RS485_Read_UX.c                         */
    ...
    /*                                                                                                    */
	/*	" gcc -o USB2SERIAL_RS485_Read_UX USB2SERIAL_RS485_Read_UX.c  "                                   */
	/*                                                                                                    */
    /* 2) Linux will not allow you to access the serial port from user space,you have to be root.So use   */
    /*    "sudo" command to execute the compiled binary as super user.                                    */
    /*                                                                                                    */
    /*       "sudo ./USB2SERIAL_RS485_Read_UX"                                                            */
	/*                                                                                                    */
	/*====================================================================================================*/
